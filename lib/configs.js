Meteor.startup(function () {
  if (_.isEmpty(Meteor.settings)) {
    throw new Error('Seems like you haven\'t started with the settings.json file please start Stitch with the following command "meteor run --settings settings.json"');
  }
